...
<body class="body-results">
	...
	<? $i=0; ?>
	<? $j=0; ?>
	<? foreach ($questions_groups_tab1 as $key => $value) { ?>
		...
		<header class="rs-section-head section-1">	
			<div class="rs-section-inner">
				<div class="roundel">
					...
					<p class="roundel-text heading-1"><? echo $j; ?></p>
				</div>
		...
		<section class="rs-section-container">
		  <div class="rs-section-inner">
			<div class="rs-table">
				...
				<!-- get  -->
				<? foreach ($questions_tab1[$key] as $key2 => $value2) { ?>			

					<? $i++; ?>	

					<? 	
					$key1=0;
					foreach ($question2top100_tab as $key3 => $value3) { 
						if ($key2 == $value3) { 
							$key1=$key3; 
						}
					} 
			...
			<? if ($key1 == 1) { ?>
			  ...
			  <div class="rs-table-row">
				<div class="rs-table-col">
				  ...
				  <p class="rs-question"><? echo $value2; ?></p>
				</div>
				<div class="rs-table-col"> 
			  ...
			  <div class="rs-table-row">
				...
				<div class="rs-table-col">
					<div style="float:left;">     	
						<div class="circle1_100">     		
							<?
							//echo "questionnaries_answers5_3_tab ".$key1." -- ".$questionnaries_answers5_3_tab[$question2top100_tab[$key1]]."<br>";
				...
				<div class="rs-table-col">
				  <div class="rs-table-col-split">
					<div class="rs-line-chart line_chart_1">
						...
						margin-left: <? echo $questionnaries_answers_top100_tab2_2[$key1]; ?>%;background-color: #36a2e4 !important;top:0px;top: 17px;"></span>
					</div>
					<div class="rs-circle-chart-text circle1_2" >
						<p>Question asked to Top100 team:</p>
				...
				<div class="rs-table-col">
				  <div class="rs-table-col-split">
					<div class="rs-line-chart line_chart_1">
						<span class="rs-line-item rs-line-blue" 
						style="display:block;width: <? echo $questionnaries_answers_top100_tab2_1[$key1]; ?>%;
						margin-left: <? echo $questionnaries_answers_top100_tab2_2[$key1]; ?>%;top:17px;"></span>
					</div>
					<div class="rs-circle-chart-text circle1_2" >
						<p>Question asked to Top100 team:</p>
						<p class="question_asked"><? echo $questions99_tab[$question2top100_tab[$key1]]; ?></p>
