angular.module('webApp', [])
  ...
  .controller('formControler', function ($scope, $http, $timeout) {
    ...
    $http.get("php/get_type.php").success(function (response) {
      $("#type1").val(response);
	  if (response == 10) {
		$(".only_top100").css("display","none");
	  } 
	  
	  if (response == ' ') {	
	  
		$("#section_name").css("display","none");	 
		$("#section_introduction").css("display","none");	  	
		$("#section_start").css("display","none");	  		
    ...
    $http.get("php/get_users.php").success(function (response) {
      $("#name").html(response);
    });
    ...
    $http.get("php/get_questions.php").success(function (response) {
      ...
      $("#website_width").val(website_width);
              ...
              if (id2 !== 'sortable1') {
                ...
                $("#" + id2 + " .button-mini").each(function() {					
                  ...
                  if (ui_id2[1] === testid2[1]) {
					...
					if (id2 === 'sortable2') {
						$("#pic_com1_"+testid2[1]+"_"+testid2[2]).val('-1');
					} else if (id2 === 'sortable3') {
						$("#pic_com1_"+testid2[1]+"_"+testid2[2]).val('0');
...
function personController ($scope, $http) {
  ...
  $scope.submit = function () {
    ...
    $(".values").each(function () {
      ...
      //check if this block is displayed
    ...
    var save_parameters_pic_com1_id_tab = new Array();
    var save_parameters_pic_com1_val_tab = new Array();

	i = 0;
    $(".pic_com1").each(function() {
      //alert($(this).attr('id'));
	  if ($(this).attr('id') != '') {
		  save_parameters_pic_com1_id_tab[i] = $(this).attr('id');
		  save_parameters_pic_com1_val_tab[i] = $(this).val();	  
		  i++;
	  }
    });	
	
	//console.log(save_parameters_pic_com1_id_tab);
	//console.log(save_parameters_pic_com1_val_tab);
	
	var name1 = $(".name1").val();
  var type1 = $("#type1").val();
  var website_width = $("#website_width").val();
    ...
    $.post("php/send_form.php", {		
      ...
      'save_parameters_pic_com1_id_tab': save_parameters_pic_com1_id_tab,
      'save_parameters_pic_com1_val_tab': save_parameters_pic_com1_val_tab
    }, function (data) {
